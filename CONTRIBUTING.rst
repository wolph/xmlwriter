...
Report bugs at https://github.com/WoLpH/xmlwriter/issues.
...
XmlWriter could always use more documentation, whether as part of the 
official XmlWriter docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/WoLpH/xmlwriter/issues.
...
Ready to contribute? Here's how to set up `xmlwriter` for local development.

1. Fork the `xmlwriter` repo on GitHub.
2. Clone your fork locally::

    $ git clone --branch develop git@github.com:your_name_here/xmlwriter.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv xmlwriter
    $ cd xmlwriter/
    $ pip install -e .
...
3. The pull request should work for Python 2.7, 3.3, and for PyPy. Check 
   https://travis-ci.org/WoLpH/xmlwriter/pull_requests
